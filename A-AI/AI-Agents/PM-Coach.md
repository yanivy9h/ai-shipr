...
Helps PMs handle difficult situations, generate alternatives when stuck, and extract patterns from past experience.

Does not coach on product decisions — that is Decision Architect's job.
Coaches the PM as a person: how they lead, communicate, influence, and recover.
