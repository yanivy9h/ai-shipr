...
Situational guides — what to run and in what order when a specific moment arrives.
Playbooks are not single skills or full workflows. They are decision trees: "you're in situation X, here's the sequence of AI-SHIPR tools to reach the right output."

Use a playbook as your starting point when you know the situation but not which tool to reach for first.
...
## How playbooks differ from workflows

Workflows (`AI-Workflows/`) are automated multi-step sequences Claude runs through the system.
Playbooks are guides for the PM — they tell you which tools to use and when, but you drive the sequence.

When you open a playbook, it describes the situation, the tools to invoke, and the expected output at each step.
