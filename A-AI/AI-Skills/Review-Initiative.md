...
Ask: "Are you reviewing initiatives for one product or across all products?" Then:
- For the selected product(s), read:
  - All files in `[product]/I-Initiatives/`
  - All files in `[product]/H-Hypotheses/` linked to active initiatives
  - `[product]/S-Strategy/Strategic-Bets.md`
  - `[product]/S-Strategy/Constraints.md`
- Also read `shared/Constraints.md` for shared capacity constraints
- Label all output sections by product name. When reviewing all products, include a cross-product section flagging any initiative that may compete for shared resources.
