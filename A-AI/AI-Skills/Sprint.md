...
- Ask the PM which product this sprint covers, or if it spans multiple products.
- For the relevant product(s) listed under `products:` in Settings.md:
  - `[product]/S-Strategy/Strategic-Bets.md`
  - All files in `[product]/I-Initiatives/`
- Read `shared/Constraints.md` for any shared capacity constraints.
- Label sprint output with the product name(s) it covers.
